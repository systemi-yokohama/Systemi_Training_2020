package Java_Training.practice100.no107.no059;
...
public class No059 {
	...
	/**
	 * 059の解答です. 引数に指定されたURLにアクセスし、 レスポンスコードを標準出力. URLのヘッダやボディの内容はファイルに出力する.
	 *
	 * 復帰値 0:正常終了 1:引数に指定したURLを見直して下さい. 2:引数に指定したURLのホストまたはDNS設定を見直して下さい.
	 * 3:再度接続し直して下さい.
	 *
