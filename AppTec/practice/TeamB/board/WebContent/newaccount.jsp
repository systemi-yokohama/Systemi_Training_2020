...
<header>
	...
	<form action="UserManagement_Servlet" name="new_return" method="post">
		<input type="submit" onclick="location.href ='./usermanagement.jsp'"
			value="戻る" formnovalidate
...
<body>
	<form action="NewAccount_Servlet" method="post">
		<br />
		<ul>
			<li><label for="user_account">アカウント名</label> <input
				name="user_account" type="text" id="user_account" required /></li>

			<br>

			<li><label for="user_password">パスワード</label> <input
				name="user_password" type="password" id="user_password" required />
			</li>
			...
			<li><label for="user_name">名称</label> <input name="user_name"
				type="text" id="user_name" required /></li>

			<br>

			<li><label for="user_office">支社</label> <select
				name="user_office" size="1" id="user_department">
			...
			<li><label for="user_department">部署</label> <select
				name="user_department" size="1" id="user_department">
