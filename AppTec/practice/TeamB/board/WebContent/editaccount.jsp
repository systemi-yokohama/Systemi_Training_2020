...
<body>
	<form action="EditAccountUpdate_Servlet" method="post" ><br />
  <c:forEach var="user" items="${userslist}">
      <ul>
		    <li >
		      <label for="new_user_account" >アカウント名</label>
		       <input type="hidden" name="old_user_account" value="${user.user_account}">
		      <input name="new_user_account" type="text" id="user_account"  value="${user.user_account}"/>
		    </li>
		    <br/>
            <li>
			  <label for="user_password">パスワード</label>
		      <input name="user_password" type="text" id="user_password"/>
            </li>
            <br/>
            <li>
			  <label for="check_user_password">パスワード確認</label>
		      <input name="check_user_password" type="text" id="check_user_password" />
		    </li>
		    <br/>
		    <li>
            ...
            <li>
			  ...
			  <!--<input name="user_office" type="text" id="user_office"  value="${user.office_name}"/>  -->
            ...
            <li>
		      ...
		      <!--<input name="user_department" type="text" id="user_department" value="${user.department_name}"/>-->
            ...
            <li class="new_registration_buttun">
			  <input type="submit" name="new_button" value="登録"  onClick="touroku()">
            </li>
	    </ul>
	    </c:forEach>
	  </form>
