package dao;
 ...
 public class UserDao {
 	...
 	public User select(Connection connection, String accountOrEmail, String password,int id) {

         PreparedStatement ps = null;
         try {
             String sql = "SELECT * FROM users WHERE (account = ? OR email = ?) AND password = ? AND id=?";
